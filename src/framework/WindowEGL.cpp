...
// -----------------------------------------------------------------------------
WindowEGL *WindowEGL::create(int width, int height, bool offscreen)
{
#if VIBRANTE_V5Q
    return (new WindowQNXEGL(width, height, offscreen));
#elif VIBRANTE_V5L
    return (new WindowLinuxEGL(width, height, offscreen));
#else
    throw std::runtime_error("WindowEGL: platform not supported");
#endif
}

// -----------------------------------------------------------------------------
WindowEGL::WindowEGL(int width, int height, bool offscreen)
