...
public:
    SimpleRecordingPlayer(ISensorEventHandler *handler)
        ...
        , m_pendingLidarPacket(nullptr)
        , m_lastLidarPacket(nullptr)
    {
    }
...
protected:
    ...
    const dwLidarDecodedPacket *m_lastLidarPacket;
