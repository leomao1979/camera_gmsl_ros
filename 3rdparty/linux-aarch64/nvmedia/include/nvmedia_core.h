...
/** \brief Minor Version number */
#define NVMEDIA_CORE_VERSION_MINOR   3
 ...
 *
 * Data structures include images, ROI's, 2d points, and scalars.
 */
typedef struct {
...
/**
 * \brief Destroys a palette created by \ref NvMediaPaletteCreate.
 * \param[in] palette A pointer to the palette to be destroyed.
 */
void
 ...
 * \param[in] rgba A 256-element array of uint32_t RGBA values. Each 32-bit
