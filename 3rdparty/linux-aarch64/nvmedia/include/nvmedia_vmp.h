 ...
 *
 * @b Description: This file contains the \ref mixer_api "Image VMP Processing API".
 */
...
/**
 * \hideinitializer
 * \brief Video is interlaced and it needs deiterlacing.
 */
#define NVMEDIA_VMP_FEATURE_DEINTERLACING                   (1<<2)

/**
 * \hideinitializer
 * \brief Enable support for advanced1 de-interlacing
 */
 ...
 * More specifically, this funciton does the following:
 *  1. Performs video post-processing and composites to a surface.
 *     For more information, see \ref NvMediaVideoMixerRenderSurface().
 *  2. Uses the alpha surface to replace the the alpha channel in the
 *     output of step 1.
